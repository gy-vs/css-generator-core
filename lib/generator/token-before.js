...
// Emit no white space before a token, but keep tracking a token code.
// Used to emit tokens of a chunk (e.g. a Raw node value) as is, since
// the tokens of a chunk are already separated in a source text and
// require no white space insertion between them
export const none = (prevCode, type, value) => code(type, value);
